...
export const EMIPreview: React.FC = () => {
  ...
  return (
    <SectionWrapper
      ...
      subtitle="Interactive loan calculator designed for immediate underwriting evaluation and principal breakdown."
    >
      <Container>
        <div ref={containerRef} className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
